...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system:
      ...
      Протокол встречи не пиши в таблице. Сделай структурированный ответ как просят с разбивкой и выделением. Если данные для протокола отстуствуют, просто пиши прочерк там, где данныхх нет.
